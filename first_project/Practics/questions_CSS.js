...
В случае если необходимо, чтобы былп поддержка IE8 и ниже необходимо использовать позиционирование, так как transform относится к CSS3, а position к CSS2.
------------------------------------------------------------------------------------------
