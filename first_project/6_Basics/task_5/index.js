...
// если делаю стартовое число number = 100 и обратную логику, у меня получается в конце summ = 4950, т.е. первой сотни не хватает, из которой сразу вычитается единица.
